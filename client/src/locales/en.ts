const translations = {
  ...
  "about.theorySection.context.p1":
    "Dr. Nikodem Popławski, a professor at the University of New Haven, proposed a revolutionary cosmological theory that fundamentally changes our understanding of black holes and the origin of the universe. His research focuses on applying the Einstein-Cartan theory, which extends general relativity by introducing a property of space known as torsion.",
  "about.theorySection.context.p2":
    "Dr. Popławski's main discovery is that matter crossing a black hole's event horizon does not form a singularity (a point of infinite density) as predicted by standard relativity. Instead, due to quantum effects and spatial torsion, matter rebounds, creating a new, expanding universe.",
  ...
  "about.theorySection.observations.p1":
    "Dr. Popławski's theory, though revolutionary, has the potential for observational verification. According to his scientific papers, it is possible to find signatures of the theory in:",
  ...
  "about.theorySection.observations.p2":
    "Dr. Popławski's research continues at the University of New Haven, where he conducts further mathematical analyses and seeks empirical evidence to support his theory of a universe inside a black hole.",
