...
export default function ContactAdmin() {
  ...
  return (
    <>
      <Helmet>
        <title>{currentLanguage === 'en' ? 'Contact Administrator' : 'Kontakt z Administratorem'} | {t('navbar.universe')} {t('navbar.in')} {t('navbar.blackHole')}</title>
        <meta name="description" content={currentLanguage === 'en' ? 'Contact the administrator of the Universe in a Black Hole website.' : 'Skontaktuj się z administratorem strony Wszechświat w Czarnej Dziurze.'} />
      </Helmet>
              ...
              {isSubmitted ? (
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-900 rounded-lg p-6 text-center">
                  ...
                  <h3 className="text-xl font-medium text-green-800 dark:text-green-200 mb-2">
                    {currentLanguage === 'en' ? 'Message Sent Successfully!' : 'Wiadomość Wysłana Pomyślnie!'}
                  </h3>
                ...
                >
                  ...
                  >
                    ...
                    {isSubmitting 
                      ? (currentLanguage === 'en' ? 'Sending...' : 'Wysyłanie...')
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">admin@universeinblackhole.org</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-sm font-medium text-foreground">
                        {currentLanguage === 'en' ? 'Support Hours' : 'Godziny Wsparcia'}
                      </h3>
